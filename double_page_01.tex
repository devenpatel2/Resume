 ...
 \section{EXPERIENCE}
   ...
   \end{tabbing}      % suppress blank line after tabbing
    ...
    \begin{itemize}
        ...
        % \item Designed
        %and implemented a speech analysis application in python
    %using Google's Web Speech API with an accuracy of 70\%. The application takes user's speech and
    %compute statistics like number of words, speed, repeated words, number of unintelligent words etc.  
    \end{itemize}
